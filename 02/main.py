...
from cn_cove.data.vocab import make_vocab_file, Vocabulary, get_vocab_size, get_data_rows, words_from_vocab
...
parser.add_argument('--n_cnns', help='the num layer of cnn', default=2)
parser.add_argument('--cnn_dropout', help='the dropout rate of cnn model', default=0.2)
parser.add_argument('--n_highway', help='the number of highway layers', default=1)
...
parser.add_argument('--clip_norm', help="the max norm of grad", default=10)
parser.add_argument('--neg_size', help='the number of neg samples', default=10)
...
parser.add_argument('--save_model_every_seconds', help='save model every num seconds', default=80)
parser.add_argument('--num_models_to_save', help='save at most num models', default=3)
...
if __name__ == "__main__":
    ...
    #     print(k)
    words = ['中国', '秦始皇', '股票', '狗', '跳舞', '数学', '书法', '一', '奥巴马', '黄河']
